 ...
 * @author familia BS
 */
public class ReportePromedioAtencion extends javax.swing.JFrame {

    /**
     * Creates new form ReporteMasVendidos
     */
    public ReportePromedioAtencion() throws SQLException {
        initComponents();
        cargar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportePromedioAtencion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ReportePromedioAtencion().setVisible(true);
                } catch (SQLException ex) {
