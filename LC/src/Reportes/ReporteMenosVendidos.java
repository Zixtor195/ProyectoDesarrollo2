 ...
 * @author familia BS
 */
public class ReporteMenosVendidos extends javax.swing.JFrame {

    /**
     * Creates new form ReporteMasVendidos
     */
    public ReporteMenosVendidos() throws SQLException {
        initComponents();
        cargar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteMenosVendidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ReporteMenosVendidos().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ReporteMenosVendidos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
